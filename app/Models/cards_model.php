...
class cards_model extends Model
{
	...
	protected $fillable = [
        'client_id', 'user_id', 'web_user_id', 'title', 'short_descr', 'tags', 'short_code', 'card_context', 'card_objects', 'designed_by_user_id', 'sender_user_id', 'sender_name', 'seal_design', 'background_image', 'envelop_design_id', 'envelop_inside_image', 'effect_name', 'canvas_image', 'stamp_image', 'stamp_design', 'card_image', 'music_title', 'music_file', 'recipient_name', 'front_image', 'back_image', 'flap_image', 'card_credits_price', 'base_lang', 'active'
    ];

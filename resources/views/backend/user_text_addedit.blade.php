    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="{{route('backend.user_text.'.$submit_path)}}" method="POST" ENCTYPE="multipart/form-data">
                        @csrf
                        <div class="card-header">
                            <div class="row" >
                                ...
                                <div class="col-3 text-end">
                                    <a href="{{route('backend.user_text')}}" class="btn btn-info btn-md"  >List Page</a>
                                </div> 
                            </div>
                        </div>
                        <div class="card-body">
...
<div class="col-md-6 mt-3">
	<div class="form-group">
		<label class="form-label" for="user_text">TEXT</label>
		<input
			type="text"
			id="user_text"
			name="user_text"
			class="form-control"
			value="@if(isset($row->user_text)){{$row->user_text}}@endif"
			
		/>
	</div>
	<div id="diverr_user_text" text-danger></div>
</div>


<div class="col-md-6 mt-3">
	<div class="form-group">
		<label class="form-label" for="user_text_alignment">ALIGNMENT</label>
		<input
			type="text"
			id="user_text_alignment"
			name="user_text_alignment"
			class="form-control"
			value="@if(isset($row->user_text_alignment)){{$row->user_text_alignment}}@endif"
			
		/>
	</div>
	<div id="diverr_user_text_alignment" text-danger></div>
</div>


<div class="col-md-6 mt-3">
	<div class="form-group">
		<label class="form-label" for="user_text_font_size">FONT SIZE</label>
		<input
			type="text"
			id="user_text_font_size"
			name="user_text_font_size"
			class="form-control"
			value="@if(isset($row->user_text_font_size)){{$row->user_text_font_size}}@endif"
			
		/>
	</div>
	<div id="diverr_user_text_font_size" text-danger></div>
</div>

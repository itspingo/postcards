    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="{{route('backend.widgets_ticket_type.'.$submit_path)}}" method="POST" ENCTYPE="multipart/form-data">
                        @csrf
                        <div class="card-header">
                            <div class="row" >
                                ...
                                <div class="col-3 text-end">
                                    <a href="{{route('backend.widgets_ticket_type')}}" class="btn btn-info btn-md"  >List Page</a>
                                </div> 
                            </div>
                        </div>
                        <div class="card-body">
...
<div class="col-md-6 mt-3">
	<div class="form-group">
		<label class="form-label" for="widget_name">WIDGET NAME</label>
		<input
			type="text"
			id="widget_name"
			name="widget_name"
			class="form-control"
			value="@if(isset($row->widget_name)){{$row->widget_name}}@endif"
			
		/>
	</div>
	<div id="diverr_widget_name" text-danger></div>
</div>
...
@php
 ...
 <div id="diverr_ticket_type_id" text-danger></div>
</div>

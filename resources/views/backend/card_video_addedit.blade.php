                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <div class="form-group">
                                                ...
                                                <input type="file" id="video_link" name="video_link" class="form-control">
                                                <div>
                                                    @php
                                                    if(!Empty($row)){
                                        ...
                                        <input type="hidden" id="ticket_type_id" name="ticket_type_id" value="@if(isset($row->ticket_type_id)) {{ $row->ticket_type_id }} @endif" />

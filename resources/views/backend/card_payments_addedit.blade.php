...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="{{route('backend.card_payments.'.$submit_path)}}" method="POST" ENCTYPE="multipart/form-data">
                        @csrf
                        <div class="card-header">
                            <div class="row" >
                                ...
                                <div class="col-3 text-end">
                                    <a href="{{route('backend.card_payments')}}" class="btn btn-info btn-md"  >List Page</a>
                                </div> 
                            </div>
                        </div>
                        <div class="card-body">
    ...
    <label class="form-label" for="web_user_id">WEB USER</label>
...
<div class="col-md-6 mt-3">
	<div class="form-group">
		<label for='amount' for="amount">AMOUNT</label>
		<input
			type="number"
			id="amount"
			name="amount"
			...
			value="@if(isset($row->amount)) {{ $row->amount }} @endif"
...
<div class="col-md-6 mt-3">
	<div class="form-group">
		<label class="form-label" for="transaction_id">TRANSACTION</label>
		<input
			type="text"
			id="transaction_id"
			name="transaction_id"
			class="form-control"
			value="@if(isset($row->transaction_id)){{$row->transaction_id}}@endif"
			
		/>
	</div>
	<div id="diverr_transaction_id" text-danger></div>
</div>

    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="{{route('backend.user_images.'.$submit_path)}}" method="POST" ENCTYPE="multipart/form-data">
                        @csrf
                        <div class="card-header">
                            <div class="row" >
                                ...
                                <div class="col-3 text-end">
                                    <a href="{{route('backend.user_images')}}" class="btn btn-info btn-md"  >List Page</a>
                                </div> 
                            </div>
                        </div>
                        <div class="card-body">
		...
		<input
			...
			<div>
				@if(isset($row) && !Empty($row))
					<img src="{{url('storage/'.str_replace('public/','',$row->image_url))}}" width="200px" height="250px" />                                                    
				@endif
			</div>

	</div>
	<div id="diverr_image_url" text-danger></div>
</div>

    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="{{route('backend.link.'.$submit_path)}}" method="POST" ENCTYPE="multipart/form-data">
                        @csrf
                        <div class="card-header">
                            <div class="row" >
                                ...
                                <div class="col-3 text-end">
                                    <a href="{{route('backend.link')}}" class="btn btn-info btn-md"  >List Page</a>
                                </div> 
                            </div>
                        </div>
                        <div class="card-body">
...
<div class="col-md-6 mt-3">
	<div class="form-group">
		...
		<input
			...
			name="link_text"
			class="form-control"
			value="@if(isset($row->link_text)){{$row->link_text}}@endif"
			
		/>
	</div>
	<div id="diverr_link_text" text-danger></div>
</div>
...
<div class="col-md-6 mt-3">
	<div class="form-group">
		...
		<input
			...
			name="link_url"
			class="form-control"
			value="@if(isset($row->link_url)){{$row->link_url}}@endif"
			
		/>
	</div>
	<div id="diverr_link_url" text-danger></div>
</div>

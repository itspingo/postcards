    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="{{route('backend.custom_user_images.'.$submit_path)}}" method="POST" ENCTYPE="multipart/form-data">
                        @csrf
                        <div class="card-header">
                            <div class="row" >
                                ...
                                <div class="col-3 text-end">
                                    <a href="{{route('backend.custom_user_images')}}" class="btn btn-info btn-md"  >List Page</a>
                                </div> 
                            </div>
                        </div>
                        <div class="card-body">
...
<div class="col-md-6 mt-3">
	...
	<div class="form-group">
    <label class="form-label" for="custom_user_image">CUSTOM USER IMAGE</label>

@php
    
    if(!Empty($row)){ 
        $selected = $row->custom_user_image; 
    }else{
        $selected = '';
    }
    $options = get_list_values('','');
    //pre($options);
	//$options = $custom_user_image;
 @endphp

		 <select class="form-control" name="custom_user_image" id="custom_user_image"> 
 ...
 <div id="diverr_custom_user_image" text-danger></div>
</div>

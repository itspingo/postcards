    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="{{route('backend.custom_user_voices.'.$submit_path)}}" method="POST" ENCTYPE="multipart/form-data">
                        @csrf
                        <div class="card-header">
                            <div class="row" >
                                ...
                                <div class="col-3 text-end">
                                    <a href="{{route('backend.custom_user_voices')}}" class="btn btn-info btn-md"  >List Page</a>
                                </div> 
                            </div>
                        </div>
                        <div class="card-body">
...
<div class="col-md-6 mt-3">
	<div class="form-group">
		<label class="form-label" for="custom_user_voice">USER VOICE</label>
		<input
			type="file"
			id="custom_user_voice"
			name="custom_user_voice"
			class="form-control"
			...
			<div>			   
			    @php 
					if(!Empty($row)){ 
						echo '<a target="_BLANK" href="'.$row->custom_user_voice.'" >'.$row->custom_user_voice.'</a>';
					} 
				@endphp
			</div>
			
	</div>
	<div id="diverr_custom_user_voice" text-danger></div>
</div>

    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="{{route('backend.card_recipients.'.$submit_path)}}" method="POST" ENCTYPE="multipart/form-data">
                        @csrf
                        <div class="card-header">
                            <div class="row" >
                                ...
                                <div class="col-3 text-end">
                                    <a href="{{route('backend.card_recipients')}}" class="btn btn-info btn-md"  >List Page</a>
                                </div> 
                            </div>
                        </div>
                        <div class="card-body">
...
<div class="col-md-6 mt-3">
	<div class="form-group">
		...
		<input
			...
			name="prefix"
			class="form-control"
			value="@if(isset($row->prefix)){{$row->prefix}}@endif"
			
		/>
	</div>
	<div id="diverr_prefix" text-danger></div>
</div>
...
<div class="col-md-6 mt-3">
	<div class="form-group">
		...
		<input
			...
			name="recipient_name"
			class="form-control"
			value="@if(isset($row->recipient_name)){{$row->recipient_name}}@endif"
			
		/>
	</div>
	<div id="diverr_recipient_name" text-danger></div>
</div>
...
<div class="col-md-6 mt-3">
	<div class="form-group">
		...
		<input
			...
			name="mobile_no"
			class="form-control"
			value="@if(isset($row->mobile_no)){{$row->mobile_no}}@endif"
			
		/>
	</div>
	<div id="diverr_mobile_no" text-danger></div>
</div>

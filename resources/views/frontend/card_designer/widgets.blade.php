 ...
 <div id="div_widgets" class="jetp-dialog-overlay show" style="display: none;" dir="ltr">
     <div class="jetp-dialog medium" style="width: 600px;">
         <div class="jetp-header">
             ...
             <div class="jetp-close"><svg xmlns="http://www.w3.org/2000/svg" onclick="hide_div('div_widgets')"
                     xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24"
         ...
         <div class="jetp-content wscrollbar jetp-lb0hm">
             <div class="jetp-manage-widget w-100">
                 <div id="widget_default" class="empty-message p-20-10">
                     ...
                     <div class="plan" style="display: flex;"><span class="ml-5"><span wudooh="true"
                                 style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                 <font style="vertical-align: inherit;">
                             ...
                             width="24" height="24" viewBox="0 0 24 24" class="icon" title="golden"
                         ...
                         </svg><span style="margin: 0px 2px;"><span wudooh="true"
                                 style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                 <font style="vertical-align: inherit;">
                             ...
                             xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor"
                             width="24" height="24" viewBox="0 0 24 24" class="icon" title="silver"
         ...
         <div class="jetp-footer p-20-10" style="display: flex; justify-content: center;">
             ...
             <div class="btn-add-widget primary-hover">
                 <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                     fill="currentColor" width="24" height="24" viewBox="0 0 24 24" class="icon ml-5">
 ...
 <div id="div_widgets_list" class="jetp-dialog-overlay show" style="display: none;">
     <div class="jetp-dialog medium" style="width: 600px;">
         <div class="jetp-header">
             ...
             <div style="display: none;"></div>
             <div class="jetp-close"><svg xmlns="http://www.w3.org/2000/svg" onclick="hide_div('div_widgets_list')"
                     xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24"
                     height="24" viewBox="0 0 24 24" class="icon">
                     <path
                         d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z">
         ...
         <div class="jetp-content nice-scrollbar">
             <div class="jetp-select-widget w-100">
                 <div class="widget-cover"
                     onclick = "showhide('div_widgets_link',['div_widgets_list','div_widgets_question','div_widgets_timer','div_widgets_memorial',
                 ...
                 <div class="widget-cover"
                     onclick = "showhide('div_widgets_timer',['div_widgets_list','div_widgets_question','div_widgets_link','div_widgets_memorial',
                            'div_widgets_optional_question','div_widgets_text_question','div_widgets_text_description','div_widgets_comm_landline',
                            'div_widgets_comm_phoneno','div_widgets_comm_sms','div_widgets_comm_email','div_widgets_comm_whatsapp','div_widgets_social_network',
                 ...
                 <div class="widget-cover"
                     onclick = "showhide('div_widgets_question',['div_widgets_list','div_widgets_timer','div_widgets_link','div_widgets_memorial',
                        'div_widgets_optional_question','div_widgets_text_question','div_widgets_text_description','div_widgets_comm_landline',
                        'div_widgets_comm_phoneno','div_widgets_comm_sms','div_widgets_comm_email','div_widgets_comm_whatsapp','div_widgets_social_network',
                     ...
                     <div class="widget primary-hover"><svg xmlns="http://www.w3.org/2000/svg"
                             ...
                             width="24" height="24" viewBox="0 0 24 24" class="icon primary-color">
                             <path
                                 d="M11.7,8.1h11.1v2.2H11.7V8.1 M11.7,15.9h11.1v2.2H11.7V15.9 M5.1,11.3L1.2,7.4l1.6-1.6l2.3,2.3L10.2,3l1.6,1.6L5.1,11.3z M5.1,15.5l2.4-2.4L9,14.7L6.7,17L9,19.4L7.5,21l-2.4-2.4L2.7,21l-1.6-1.6L3.5,17l-2.4-2.4l1.6-1.6L5.1,15.5z">
                             </path>
                         </svg>
                         <div><span wudooh="true"
                                 style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                 ...
                 <div class="widget-cover"
                     onclick = "showhide('div_widgets_text_question',['div_widgets_list','div_widgets_question','div_widgets_timer','div_widgets_link','div_widgets_memorial',
                 ...
                 <div class="widget-cover"
                     onclick = "showhide('div_widgets_optional_question',['div_widgets_list','div_widgets_question','div_widgets_timer','div_widgets_link','div_widgets_memorial',
                 ...
                 <div class="widget-cover"
                     onclick = "showhide('div_widgets_memorial',['div_widgets_list','div_widgets_question','div_widgets_timer','div_widgets_link',
                            'div_widgets_optional_question','div_widgets_text_question','div_widgets_text_description','div_widgets_comm_landline',
                            'div_widgets_comm_phoneno','div_widgets_comm_sms','div_widgets_comm_email','div_widgets_comm_whatsapp','div_widgets_social_network',
                 ...
                 <div class="widget-cover"
                     onclick = "showhide('div_widgets_social_network',['div_widgets_list','div_widgets_question','div_widgets_timer','div_widgets_link','div_widgets_memorial',
                            'div_widgets_optional_question','div_widgets_text_question','div_widgets_text_description','div_widgets_comm_landline',
                 ...
                 <div class="widget-cover"
                     onclick = "showhide('div_widgets_comm_landline',['div_widgets_list','div_widgets_question','div_widgets_timer','div_widgets_link','div_widgets_memorial',
                 ...
                 <div class="widget-cover"
                     onclick = "showhide('div_widgets_text_description',['div_widgets_list','div_widgets_question','div_widgets_timer','div_widgets_link','div_widgets_memorial',
                 ...
                 <div class="widget-cover"
                     onclick = "showhide('div_widgets_separator',['div_widgets_list','div_widgets_question','div_widgets_timer','div_widgets_link','div_widgets_memorial',
                    'div_widgets_optional_question','div_widgets_text_question','div_widgets_text_description','div_widgets_comm_landline',
                    'div_widgets_comm_phoneno','div_widgets_comm_sms','div_widgets_comm_email','div_widgets_comm_whatsapp','div_widgets_social_network',
                 ...
                 <div class="widget-cover"
                     onclick = "showhide('div_widgets_video',['div_widgets_list','div_widgets_question','div_widgets_timer','div_widgets_link','div_widgets_memorial',
                        'div_widgets_optional_question','div_widgets_text_question','div_widgets_text_description','div_widgets_comm_landline',
                        'div_widgets_comm_phoneno','div_widgets_comm_sms','div_widgets_comm_email','div_widgets_comm_whatsapp','div_widgets_social_network',
                 ...
                 <div class="widget-cover"
                     onclick = "showhide('div_widgets_image',['div_widgets_list','div_widgets_question','div_widgets_timer','div_widgets_link','div_widgets_memorial',
                        'div_widgets_optional_question','div_widgets_text_question','div_widgets_text_description','div_widgets_comm_landline',
                        'div_widgets_comm_phoneno','div_widgets_comm_sms','div_widgets_comm_email','div_widgets_comm_whatsapp','div_widgets_social_network',
     ...
     <div class="jetp-dialog auto-size small">
         <div class="jetp-header">
             ...
             <div class="jetp-close"><svg xmlns="http://www.w3.org/2000/svg"
                     onclick="hide_div('div_widgets_question')" xmlns:xlink="http://www.w3.org/1999/xlink"
             ...
             <div class="w-100">
                 <div class="jetp-cover-input m-20-10 mt-20">
                     <div class="label"><span wudooh="true"
                         ...
                         </span></div><input type="text" id="attend_quest_title" name="attend_quest_title"
                         value="Are you attending our ceremony?" maxlength="150">
                 </div>
                 <div class="jetp-cover-input m-20-10">
                     <div class="label"><span wudooh="true"
                         ...
                         </span></div><input type="text" id="attend_quest_yes_title" name="attend_quest_yes_title"
                         value="Yes, I will participate" maxlength="50">
                 </div>
                 <div class="jetp-cover-input m-20-10">
                     <div class="label"><span wudooh="true"
                             style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                         ...
                         </span></div><input type="text" id="attend_quest_no_title" name="attend_quest_no_title"
                         value="No, I will not participate" maxlength="50">
                 </div>
                 <div class="jetp-cover-input m-20-10"><label>
                         <input class="ml-10" type="checkbox" id="attend_quest_mandatory"
                             name="attend_quest_mandatory" checked="true"><span><span wudooh="true"
                                 style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                 <font style="vertical-align: inherit;">
                 ...
                 <input type="hidden" name="recid_widget_attend_quest" id="recid_widget_attend_quest"
                     value="">
             </div>
         </div>
 ...
 <div id="div_widgets_timer" class="jetp-dialog-overlay show" style="display: none;">
     <div class="jetp-dialog auto-size small">
         <div class="jetp-header">
             ...
             <div style="display: none;"></div>
             <div class="jetp-close"><svg xmlns="http://www.w3.org/2000/svg" onclick="hide_div('div_widgets_timer')"
                     xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24"
                     height="24" viewBox="0 0 24 24" class="icon">
                     <path
                         d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z">
             ...
             <div class="w-100">
                 ...
                 <div class="jetp-cover-input m-20-10 mt-20">
                     <div class="label"><span wudooh="true"
                         ...
                         </span></div><input type="text" id="countdown_title" name="countdown_title"
                         maxlength="100">
                 </div>
                 <div class="jetp-cover-input m-20-10">
                     <div class="label"><span wudooh="true"
                         ...
                         </span></div><input type="text" id="countdown_date" name="countdown_date" maxlength="10"
                         dir="ltr" list="2foaw7"><small><span wudooh="true"
                             style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                             <font style="vertical-align: inherit;">
                                 <font style="vertical-align: inherit;">For example, 2024-10-22</font>
                             </font>
                         </span></small><small class="not-valid" style="display: none;"><span wudooh="true"
                             style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                             <font style="vertical-align: inherit;">
                 ...
                 <div class="jetp-cover-input m-20-10 mb-10">
                     <div class="label"><span wudooh="true"
                         ...
                         </span></div><input type="text" id="countdown_time" name="countdown_time" maxlength="5"
                         dir="ltr" list="kpmloa"><small><span wudooh="true"
                             style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                             <font style="vertical-align: inherit;">
 ...
 <div id="div_widgets_link" class="jetp-dialog-overlay show" style="display: none;">
     <div class="jetp-dialog auto-size small">
         <div class="jetp-header">
             ...
             <div style="display: none;"></div>
             <div class="jetp-close"><svg xmlns="http://www.w3.org/2000/svg" onclick="hide_div('div_widgets_link')"
                     xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24"
                     height="24" viewBox="0 0 24 24" class="icon">
                     <path
                         d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z">
             ...
             <div class="w-100"><datalist id="rjqkcf">
                 ...
                 <div class="jetp-cover-input m-20-10 mt-20">
                     <div class="label"><span wudooh="true"
                         ...
                         </span></div><input type="text" id="link_text" name="link_text" maxlength="20"
                         list="rjqkcf">
                 </div>
                 <div class="jetp-cover-input m-20-10">
                     <div class="label"><span wudooh="true"
                         ...
                         </span></div><input id="link_url" name="link_url" type="url" maxlength="300"
 ...
 <div id="div_widgets_memorial" class="jetp-dialog-overlay show" style="display: none;">
     <div class="jetp-dialog auto-size small">
         <div class="jetp-header">
             ...
             <div style="display: none;"></div>
             <div class="jetp-close"><svg xmlns="http://www.w3.org/2000/svg"
                     onclick="hide_div('div_widgets_memorial')" xmlns:xlink="http://www.w3.org/1999/xlink"
                     version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24"
                     class="icon">
                     <path
                         d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z">
             ...
             <div class="w-100">
                 <div class="jetp-cover-input m-20-10 mt-20">
                     <div class="label"><span wudooh="true"
                         ...
                         </span></div><input id="memorial_title" name="memorial_title" type="text"
                         maxlength="300" value="Write a message as a memorial">
                 </div>
                 <div class="jetp-cover-input m-20-10 mb-10"><label><input class="ml-10" type="checkbox"
                             id="display_oncard" name="display_oncard">
                         <div class="with-detail"><span class="title"><span wudooh="true"
                                     style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                     <font style="vertical-align: inherit;">
                                         <font style="vertical-align: inherit;">Displaying the text of memorials on
                                             postcards</font>
                                     </font>
                                 </span></span><span class="detail"><span wudooh="true"
                                     style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                     <font style="vertical-align: inherit;">
                 ...
                 <div class="jetp-cover-input m-20-10" style="display: block;">
                     <div class="label"><span wudooh="true"
                         ...
                         </span></div><input type="text" id="memorial_text" name="memorial_text" maxlength="300"
                         value="Memorials of dear relatives and acquaintances">
                 </div>
                 <div class="jetp-cover-input m-20-10 mb-10"><label><input class="ml-10" type="checkbox"
                             id="memorial_answer_mandatory" name="memorial_answer_mandatory"><span><span
                                 wudooh="true"
                                 style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                 <font style="vertical-align: inherit;">
                                     <font style="vertical-align: inherit;">The answer is mandatory</font>
                 ...
                 <div class="jetp-cover-input m-20-10"><label><input class="ml-10" type="checkbox"
                             id="memorial_presence_status" name="memorial_presence_status"><span><span wudooh="true"
                                 style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                 <font style="vertical-align: inherit;">
                     ...
                     <div class="mr-20" style="display: block;">
                         <div><label style="padding: 0px;"><input class="ml-10" type="radio" checked="checked"
                                     id="memorial_presence_yes" name="memorial_presence_yesno"
                                     value="yes"><span><span wudooh="true"
                                         style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                         <font style="vertical-align: inherit;">
                                             <font style="vertical-align: inherit;">I participate</font>
                                         </font>
                                     </span></span></label></div>
                         <div><label style="padding: 0px;"><input class="ml-10" type="radio"
                                     id="memorial_presence_no" name="memorial_presence_yesno"
                                     value="no"><span><span wudooh="true"
                                         style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                         <font style="vertical-align: inherit;">
 ...
 <div id="div_widgets_optional_question" class="jetp-dialog-overlay show" style="display: none;">
     <div class="jetp-dialog auto-size small">
         <div class="jetp-header">
             ...
             <div style="display: none;"></div>
             <div class="jetp-close"><svg xmlns="http://www.w3.org/2000/svg"
                     onclick="hide_div('div_widgets_optional_question')" xmlns:xlink="http://www.w3.org/1999/xlink"
                     version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24"
                     class="icon">
                     <path
                         d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z">
             ...
             <div class="w-100">
                 <div class="jetp-cover-input m-20-10 mt-20">
                     ...
                     <select id="optnl_quest_type" name="optnl_quest_type">
                         ...
                         <option value="radio"><span wudooh="true"
                                 style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                 <font style="vertical-align: inherit;">
                                     <font style="vertical-align: inherit;">single choice</font>
                                 </font>
                             </span></option>
                         <option value="checkbox"><span wudooh="true"
                                 style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                 <font style="vertical-align: inherit;">
                                     <font style="vertical-align: inherit;">multiple choice</font>
                                 </font>
                             </span></option>
                         <option value="dropdown"><span wudooh="true"
                                 style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                 <font style="vertical-align: inherit;">
                 ...
                 <div class="jetp-cover-input m-20-10 options" style="display: block;">
                     ...
                     <div class="jetp-question-options" id="options-container">
                         <div class="item" item="5185" style="">
                             ...
                             <button class="btn remove-option-btn"><svg xmlns="http://www.w3.org/2000/svg"
                                     xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor"
                     ...
                     <button class="jetp-add-option-button" id="add-option-btn"><svg
                             xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                             version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24"
                             class="icon">
                             <path d="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z"></path>
                         </svg><span class="ml-5"><span wudooh="true"
                                 style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                 <font style="vertical-align: inherit;">
                 ...
                 <div class="jetp-cover-input m-20-10 mb-10" style="display: block;">
                     <label><input class="ml-10" type="checkbox" id="optnl_quest_mandatory"
                             name="optnl_quest_mandatory" value='Y'><span><span wudooh="true"
                                 style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                 <font style="vertical-align: inherit;">
                                     <font style="vertical-align: inherit;">The answer is mandatory</font>
                                 </font>
                 ...
                 <div class="jetp-cover-input m-20-10" style="display: block;">
                     <label><input class="ml-10" type="checkbox" id="optnl_quest_presence_status"
                             onchange="show_optnl_quest_participating_options()"><span><span wudooh="true"
                                 style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                 <font style="vertical-align: inherit;">
                                     <font style="vertical-align: inherit;">Display based on presence status</font>
                                 </font>
                     ...
                     <div id="div_optnl_quest_isparticipating" class="mr-20" style="display: none;">
                         <div><label style="padding: 0px;"><input class="ml-10" type="radio"
                                     id="optnl_quest_foryes" checked="checked" value="yes"><span><span
                                         wudooh="true"
                                         style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                         <font style="vertical-align: inherit;">
                                             <font style="vertical-align: inherit;">I participate</font>
                         ...
                         <div><label style="padding: 0px;"><input class="ml-10" type="radio"
                                     id="optnl_quest_forno" value="no"><span><span wudooh="true"
                                         style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                         <font style="vertical-align: inherit;">
                                             <font style="vertical-align: inherit;">I do not participate</font>
                                         </font>
                 ...
                 <input type="hidden" name="recid_widget_optional_question" id="recid_widget_optional_question"
                     value="">
             </div>
         </div>
 ...
 <div id="div_widgets_text_question" class="jetp-dialog-overlay show" style="display: none;">
     <div class="jetp-dialog auto-size small">
         <div class="jetp-header">
             ...
             <div style="display: none;"></div>
             <div class="jetp-close"><svg xmlns="http://www.w3.org/2000/svg"
                     onclick="hide_div('div_widgets_text_question')" xmlns:xlink="http://www.w3.org/1999/xlink"
                     version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24"
                     class="icon">
                     <path
                         d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z">
             ...
             <div class="w-100">
                 ...
                 <div class="jetp-cover-input m-20-10" style="display: block;">
                     <div class="label"><span wudooh="true"
                         ...
                         </span></div><input type="text" id="text_question_title" name="text_question_title"
                         maxlength="300">
                 </div>
                 <div class="jetp-cover-input m-20-10 mb-10" style="display: block;"><label><input class="ml-10"
                             id="text_question_mandatory" name="text_question_mandatory"
                 ...
                 <div class="jetp-cover-input m-20-10" style="display: block;"><label><input class="ml-10"
                             id="presence_status" name="presence_status" type="checkbox"
                             onchange="show_participating_options()" value="Y"><span><span wudooh="true"
                                 style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                 <font style="vertical-align: inherit;">
                                     <font style="vertical-align: inherit;">Display based on presence status</font>
                                 </font>
                     ...
                     <div id="div_isparticipating" class="mr-20" style="display: none;">
                         <div><label style="padding: 0px;"><input class="ml-10" type="radio"
                                     id="text_question_foryes" name="text_question_foryesno" value="yes"
                         ...
                         <div><label style="padding: 0px;"><input class="ml-10" type="radio"
                                     id="text_question_forno" name="text_question_foryesno"
                                     value="no"><span><span wudooh="true"
                                         style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                         <font style="vertical-align: inherit;">
                                             <font style="vertical-align: inherit;">I do not participate</font>
                 ...
                 <input type="hidden" name="recid_widget_text_question" id="recid_widget_text_question"
                     value="">
             </div>
         </div>
         <div class="jetp-footer p-20-10" style="display: flex;">
 ...
 <div id="div_widgets_text_description" class="jetp-dialog-overlay show" style="display: none;">
     <div class="jetp-dialog auto-size small">
         <div class="jetp-header">
             ...
             <div style="display: none;"></div>
             <div class="jetp-close"><svg xmlns="http://www.w3.org/2000/svg"
                     onclick="hide_div('div_widgets_text_description')" xmlns:xlink="http://www.w3.org/1999/xlink"
                     version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24"
                     class="icon">
                     <path
                         d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z">
 ...
 <div id="div_widgets_comm_landline" class="jetp-dialog-overlay show" style="display: none;">
     <div class="jetp-dialog auto-size small">
         <div class="jetp-header">
             ...
             <div style="display: none;"></div>
             <div class="jetp-close"><svg xmlns="http://www.w3.org/2000/svg"
                     onclick="hide_div('div_widgets_comm_landline')" xmlns:xlink="http://www.w3.org/1999/xlink"
                     version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24"
                     class="icon">
                     <path
                         d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z">
             ...
             <div class="w-100">
                 <div class="jetp-cover-input m-20-10 mt-20">
                     <div class="label"><span wudooh="true"
                         ...
                         </span></div><select id="comm_type" name="comm_type"
                         onchange="change_comm_method(this.value)">
                     ...
                     <div>
                         <div class="jetp-cover-input m-20-10 mb-0">
                             <div class="label"><span wudooh="true"
                                 ...
                                 </span></div><input id="comm_tel" name="comm_tel" type="tel"
                                 maxlength="12"><small><span wudooh="true"
                                     style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                     <font style="vertical-align: inherit;">
                     ...
                     <div>
                         <div class="jetp-cover-input m-20-10 mb-0">
                             <div class="label"><span wudooh="true"
                                 ...
                                 </span></div><input id="comm_mobile" name="comm_mobile" type="tel"
                                 maxlength="12"><small><span wudooh="true"
                                     style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                     <font style="vertical-align: inherit;">
                     ...
                     <div>
                         <div class="jetp-cover-input m-20-10">
                             <div class="label"><span wudooh="true"
                                 ...
                                 </span></div><input id="comm_sms_no" name="comm_sms_no" type="tel"
                                 maxlength="12"><small><span wudooh="true"
                                     style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                     <font style="vertical-align: inherit;">
                         ...
                         <div class="jetp-cover-input m-20-10 mb-0">
                             ...
                             <textarea id="comm_sms_text" name="comm_sms_text" rows="3" maxlength="200" style="resize: none;"></textarea><small><span wudooh="true"
                                     style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                     <font style="vertical-align: inherit;">
                                         <font style="vertical-align: inherit;">The prepared text that is placed in
                                             the
                     ...
                     <div>
                         <div class="jetp-cover-input m-20-10 mb-0">
                             <div class="label"><span wudooh="true"
                                 ...
                                 </span></div><input id="comm_email" name="comm_email" type="email"
                                 maxlength="100" dir="ltr"><small><span wudooh="true"
                                     style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                     <font style="vertical-align: inherit;">
                     ...
                     <div>
                         <div class="jetp-cover-input m-20-10">
                             <div class="label"><span wudooh="true"
                                 ...
                                 </span></div><input id="comm_whatsapp_no" name="comm_whatsapp_no" type="tel"
                                 maxlength="12"><small><span wudooh="true"
                                     style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                     <font style="vertical-align: inherit;">
                                         <font style="vertical-align: inherit;">The mobile number that WhatsApp has,
                                             for
                         ...
                         <div class="jetp-cover-input m-20-10 mb-0">
                             ...
                             <textarea id="comm_whatsapp_text" name="comm_whatsapp_text" rows="3" maxlength="200"
                         ...
                         <input type="hidden" name="recid_widget_contact_comm" id="recid_widget_contact_comm"
                             value="">
                     </div>
 ...
 <div id="div_widgets_comm_phoneno" class="jetp-dialog-overlay show" style="display: none;">
     <div class="jetp-dialog auto-size small">
         <div class="jetp-header">
             ...
             <div style="display: none;"></div>
             <div class="jetp-close"><svg xmlns="http://www.w3.org/2000/svg"
                     onclick="hide_div('div_widgets_comm_phoneno')" xmlns:xlink="http://www.w3.org/1999/xlink"
                     version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24"
                     class="icon">
                     <path
                         d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z">
         ...
         <div class="jetp-content nice-scrollbar">
             <div class="w-100">
                 ...
                 <div>
                     <div class="jetp-cover-input m-20-10 mb-0">
                         <div class="label"><span wudooh="true"
                             ...
                             </span></div><input id="mobile" name="mobile" type="tel"
                             maxlength="12"><small><span wudooh="true"
                                 style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                 <font style="vertical-align: inherit;">
                                     <font style="vertical-align: inherit;">For example: 09121234567</font>
                 ...
                 <input type="hidden" name="recid_widget_comm_phoneno" id="recid_widget_comm_phoneno"
                     value="">
             </div>
         </div>
         <div class="jetp-footer p-20-10" style="display: flex;"><button class="success w-120px"><span
 ...
 <div id="div_widgets_comm_sms" class="jetp-dialog-overlay show" style="display: none;">
     <div class="jetp-dialog auto-size small">
         <div class="jetp-header">
             ...
             <div style="display: none;"></div>
             <div class="jetp-close"><svg xmlns="http://www.w3.org/2000/svg"
                     onclick="hide_div('div_widgets_comm_sms')" xmlns:xlink="http://www.w3.org/1999/xlink"
                     version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24"
                     class="icon">
                     <path
                         d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z">
             ...
             <div class="w-100">
                 ...
                 <div>
                     ...
                     <div class="jetp-cover-input m-20-10 mb-0">
                         ...
                         <textarea rows="3" maxlength="200" style="resize: none;"></textarea><small><span wudooh="true"
                                 style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                 <font style="vertical-align: inherit;">
 ...
 <div id="div_widgets_comm_email" class="jetp-dialog-overlay show" style="display: none;">
     <div class="jetp-dialog auto-size small">
         <div class="jetp-header">
             ...
             <div style="display: none;"></div>
             <div class="jetp-close"><svg xmlns="http://www.w3.org/2000/svg"
                     onclick="hide_div('div_widgets_comm_email')" xmlns:xlink="http://www.w3.org/1999/xlink"
                     version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24"
                     class="icon">
                     <path
                         d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z">
         ...
         <div class="jetp-content nice-scrollbar">
             <div class="w-100">
                 ...
                 <input type="hidden" name="recid_widget_comm_email" id="recid_widget_comm_email"
                     value="">
             </div>
         </div>
         <div class="jetp-footer p-20-10" style="display: flex;"><button class="success w-120px"><span
 ...
 <div id="div_widgets_comm_whatsapp" class="jetp-dialog-overlay show" style="display: none;">
     <div class="jetp-dialog auto-size small">
         <div class="jetp-header">
             ...
             <div style="display: none;"></div>
             <div class="jetp-close"><svg xmlns="http://www.w3.org/2000/svg"
                     onclick="hide_div('div_widgets_comm_whatsapp')" xmlns:xlink="http://www.w3.org/1999/xlink"
                     version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24"
                     class="icon">
                     <path
                         d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z">
         ...
         <div class="jetp-content nice-scrollbar">
             <div class="w-100">
                 ...
                 <input type="hidden" name="recid_widget_comm_whatsapp" id="recid_widget_comm_whatsapp"
                     value="">
             </div>
         </div>
         <div class="jetp-footer p-20-10" style="display: flex;"><button class="success w-120px"><span
 ...
 <div id="div_widgets_social_network" class="jetp-dialog-overlay show" style="display: none;">
     <div class="jetp-dialog auto-size medium">
         <div class="jetp-header">
             ...
             <div style="display: none;"></div>
             <div class="jetp-close"><svg xmlns="http://www.w3.org/2000/svg"
                     onclick="hide_div('div_widgets_social_network')" xmlns:xlink="http://www.w3.org/1999/xlink"
                     version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24"
                     class="icon">
                     <path
                         d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z">
             ...
             <div class="w-100">
                 ...
                 <div class="jetp-cover-input m-20-10">
                     ...
                     <div class="input-with-icon"><svg xmlns="http://www.w3.org/2000/svg"
                         ...
                         </svg><input type="text" id="sn_instagram" name="sn_instagram" maxlength="100"
                             dir="ltr"><svg xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor"
                             width="24" height="24" viewBox="0 0 24 24" class="icon"
                 ...
                 <div class="jetp-cover-input m-20-10">
                     ...
                     <div class="input-with-icon"><svg xmlns="http://www.w3.org/2000/svg"
                         ...
                         </svg><input type="text" id="sn_telegram" name="sn_telegram" maxlength="100"
                             dir="ltr"><svg xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor"
                             width="24" height="24" viewBox="0 0 24 24" class="icon"
                             style="padding: 9px; color: rgb(119, 119, 119);">
                 ...
                 <div class="jetp-cover-input m-20-10">
                     ...
                     <div class="input-with-icon"><svg xmlns="http://www.w3.org/2000/svg"
                         ...
                         </svg><input type="tel" id="sn_whatsapp" name="sn_whatsapp" maxlength="100"
                             dir="ltr"><svg xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor"
                             width="24" height="24" viewBox="0 0 24 24" class="icon"
                             style="padding: 9px; color: rgb(119, 119, 119);">
                 ...
                 <div class="jetp-cover-input m-20-10">
                     ...
                     <div class="input-with-icon"><svg xmlns="http://www.w3.org/2000/svg"
                         ...
                         </svg><input type="url" id="sn_facebook" name="sn_facebook" maxlength="100"
                             dir="ltr"><svg xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor"
                             width="24" height="24" viewBox="0 0 24 24" class="icon"
                             style="padding: 9px; color: rgb(119, 119, 119);">
                 ...
                 <div class="jetp-cover-input m-20-10">
                     ...
                     <div class="input-with-icon"><svg xmlns="http://www.w3.org/2000/svg"
                         ...
                         </svg><input type="url" id="sn_twitter" name="sn_twitter" maxlength="100"
                             dir="ltr"><svg xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor"
                             width="24" height="24" viewBox="0 0 24 24" class="icon"
                             style="padding: 9px; color: rgb(119, 119, 119);">
                 ...
                 <div class="jetp-cover-input m-20-10">
                     ...
                     <div class="input-with-icon"><svg xmlns="http://www.w3.org/2000/svg"
                         ...
                         </svg><input type="url" id="sn_pinterest" name="sn_pinterest" maxlength="100"
                             dir="ltr"><svg xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor"
                             width="24" height="24" viewBox="0 0 24 24" class="icon"
                             style="padding: 9px; color: rgb(119, 119, 119);">
                 ...
                 <input type="text" name="recid_widget_social_network" id="recid_widget_social_network"
                     value="">
             </div>
         </div>
 ...
 <div id="div_widgets_image" class="jetp-dialog-overlay show" style="display: none;">
     <div class="jetp-dialog auto-size small">
         <div class="jetp-header">
             ...
             <div style="display: none;"></div>
             <div class="jetp-close"><svg xmlns="http://www.w3.org/2000/svg"
                     onclick="hide_div('div_widgets_image')" xmlns:xlink="http://www.w3.org/1999/xlink"
                     version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24"
                     class="icon">
                     <path
                         d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z">
                 ...
                 <div class="jetp-file-picker"><input type="file" accept="image/*" style="display: none;">
                     <div class="jetp-file-picker-helper"><svg xmlns="http://www.w3.org/2000/svg"
                             ...
                             <path
                                 ...
                                 <font style="vertical-align: inherit;">
                                     <font style="vertical-align: inherit;">
                                         <input onchange="add_widget_image()" type="file" id="widget_image"
                                             name="widget_image" accept="image/*">
                                     </font>
                                 </font>
                             </span></span></div>
                 </div>
 ...
 <div id="div_widgets_video" class="jetp-dialog-overlay show" style="display: none;">
     <div class="jetp-dialog auto-size small">
         <div class="jetp-header">
             ...
             <div style="display: none;"></div>
             <div class="jetp-close"><svg xmlns="http://www.w3.org/2000/svg"
                     onclick="hide_div('div_widgets_video')" xmlns:xlink="http://www.w3.org/1999/xlink"
                     version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24"
                     class="icon">
                     <path
                         d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z">
             ...
             <div class="w-100">
                 <div class="jetp-cover-input m-20-10">
                     <div class="label"><span wudooh="true"
                         ...
                         </span></div><input type="url" id="video_link" name="video_link" maxlength="200"
                         dir="ltr"><small> <span wudooh="true"
                             style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                             <font style="vertical-align: inherit;">
 ...
 <div id="div_widgets_separator" class="jetp-dialog-overlay show" style="display: none;">
     <div class="jetp-dialog auto-size medium">
         <div class="jetp-header">
             ...
             <div style="display: none;"></div>
             <div class="jetp-close"><svg xmlns="http://www.w3.org/2000/svg"
                     onclick="hide_div('div_widgets_separator')" xmlns:xlink="http://www.w3.org/1999/xlink"
                     version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24"
                     class="icon">
                     <path
                         d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z">
         ...
         <div class="jetp-content nice-scrollbar">
             <div class="w-100 divider-selector">
                 ...
                 <div class="item" onclick="add_widget_separator(this)"><svg xmlns="http://www.w3.org/2000/svg"
                         xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor"
                         width="100" height="10" viewBox="0 0 100 10" class="divider p-10 primary-hover"
                 ...
                 <div class="item" onclick="add_widget_separator(this)"><svg xmlns="http://www.w3.org/2000/svg"
                         xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor"
                         width="110" height="10" viewBox="0 0 110 10" class="divider p-10 primary-hover"
                         style="width:100%;height:auto;">
                         <path
                 ...
                 <div class="item" onclick="add_widget_separator(this)"><svg xmlns="http://www.w3.org/2000/svg"
                         xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor"
                         width="110" height="13.5" viewBox="0 0 110 13.5" class="divider p-10 primary-hover"
                         style="width:100%;height:auto;">
                         <path
                 ...
                 <div class="item" onclick="add_widget_separator(this)"><svg xmlns="http://www.w3.org/2000/svg"
                         xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor"
                         width="105" height="10" viewBox="0 0 105 10" class="divider p-10 primary-hover"
                         style="width:100%;height:auto;">
                         <path
                 ...
                 <div class="item" onclick="add_widget_separator(this)"><svg xmlns="http://www.w3.org/2000/svg"
                         xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor"
                         width="105" height="13" viewBox="0 0 105 13" class="divider p-10 primary-hover"
                         style="width:100%;height:auto;">
                         <path
 ...
 <script>
     ...
     // List with handle
     if (typeof listWithHandle != 'undefined' && listWithHandle != null) {
     ...
     function edit_widget_link(recid) {
         ...
         var delete_btn_code =
             ' <button id="btn_widget_link_delete" class="linear-warning w-120px mr-a" style="display: flex;" onclick="delete_widget_link(' +
             recid + ')"> \
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24" class="icon"> \
                      <path d="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z"> \
                      </path> \
         ...
         $.ajax({
             ...
             success: function(result) {
                 ...
                 if (recid_widget_separator == '') {
                     ...
                     document.getElementById('div_widget_separator' + recid_widget_separator).innerHTML =
                         newHtml;
                 }
     ...
     function edit_widget_separator(recid) {
         ...
         var delete_btn_code =
             ' <button id="btn_widget_separator_delete" class="linear-warning w-120px mr-a" style="display: flex;" onclick="delete_widget_separator(' +
             recid + ')"> \
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24" class="icon"> \
                      <path d="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z"> \
                      </path> \
         ...
         $.ajax({
             ...
             success: function(result) {
                 ...
                 if (recid_widget_social_network == '') {
                     ...
                     document.getElementById('div_widget_social_network' + recid_widget_social_network)
                         .innerHTML = newHtml;
                 }
     ...
     function edit_widget_social_network(recid) {
         ...
         var delete_btn_code =
             ' <button id="btn_widget_social_network_delete" class="linear-warning w-120px mr-a" style="display: flex;" onclick="delete_widget_social_network(' +
             recid + ')"> \
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24" class="icon"> \
                      <path d="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z"> \
                      </path> \
     ...
     function edit_widget_video(recid) {
         ...
         var delete_btn_code =
             ' <button id="btn_widget_video_delete" class="linear-warning w-120px mr-a" style="display: flex;" onclick="delete_widget_video(' +
             recid + ')"> \
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24" class="icon"> \
                      <path d="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z"> \
                      </path> \
         ...
         $.ajax({
             ...
             success: function(result) {
                 ...
                 if (recid_widget_user_text == '') {
                     ...
                     document.getElementById('div_widget_user_text' + recid_widget_user_text).innerHTML =
                         newHtml;
                 }
     ...
     function edit_widget_user_text(recid) {
         ...
         var delete_btn_code =
             ' <button id="btn_widget_user_text_delete" class="linear-warning w-120px mr-a" style="display: flex;" onclick="delete_widget_user_text(' +
             recid + ')"> \
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24" class="icon"> \
                      <path d="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z"> \
                      </path> \
         ...
         $.ajax({
             ...
             success: function(result) {
                 ...
                 document.getElementById('div_btn_widget_text_description_delete').innerHTML =
                     delete_btn_code;
         ...
         $.ajax({
             ...
             success: function(result) {
                 ...
                 if (recid_widget_attend_quest == '') {
                     ...
                     document.getElementById('div_widget_attend_quest' + recid_widget_attend_quest)
                         .innerHTML = newHtml;
                 }
     ...
     function edit_widget_attend_quest(recid) {
         ...
         var delete_btn_code =
             '<button id="btn_widget_attend_quest_delete" class="linear-warning w-120px mr-a" style="display: flex;" onclick="delete_widget_attend_quest(' +
             recid + ')"> \
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24" class="icon"> \
                      <path d="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z"> \
                      </path> \
         ...
         $.ajax({
             ...
             success: function(result) {
                 ...
                 if (recid_widget_text_question == '') {
                     ...
                     document.getElementById('div_widget_text_question' + recid_widget_text_question)
                         .innerHTML = newHtml;
                 }
     ...
     function edit_widget_text_question(recid) {
         ...
         var delete_btn_code =
             ' <button id="btn_widget_text_question_delete" class="linear-warning w-120px mr-a" style="display: flex;" onclick="delete_widget_text_question(' +
             recid + ')"> \
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24" class="icon"> \
                      <path d="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z"> \
                      </path> \
         ...
         $.ajax({
             ...
             success: function(result) {
                 ...
                 if (recid_widget_countdown == '') {
                     ...
                     document.getElementById('div_widget_countdown' + recid_widget_countdown).innerHTML =
                         newHtml;
                 }
     ...
     function edit_widget_countdown(recid) {
         ...
         var delete_btn_code =
             ' <button id="btn_widget_countdown_delete" class="linear-warning w-120px mr-a" style="display: flex;" onclick="delete_widget_countdown(' +
             recid + ')"> \
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24" class="icon"> \
                      <path d="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z"> \
                      </path> \
         ...
         $.ajax({
             ...
             success: function(result) {
                 ...
                 if (recid_widget_optional_question == '') {
                     ...
                     document.getElementById('div_widgets_optional_question' +
                         recid_widget_optional_question).innerHTML = newHtml;
                 }
     ...
     function edit_widget_optional_question(recid) {
         ...
         var delete_btn_code =
             ' <button id="btn_widget_optional_question_delete" class="linear-warning w-120px mr-a" style="display: flex;" onclick="delete_widget_optional_question(' +
             recid + ')"> \
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24" class="icon"> \
                      <path d="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z"> \
                      </path> \
         ...
         $.ajax({
             ...
             success: function(result) {
                 ...
                 document.getElementById('div_btn_widget_optional_question_delete').innerHTML =
                     delete_btn_code;
         ...
         $.ajax({
             ...
             success: function(result) {
                 ...
                 if (recid_widget_contact_comm == '') {
                     ...
                     document.getElementById('div_widget_contact_comm' + recid_widget_contact_comm)
                         .innerHTML = newHtml;
                 }
     ...
     function edit_widget_contact_comm(recid) {
         ...
         var delete_btn_code =
             ' <button id="btn_widget_contact_comm_delete" class="linear-warning w-120px mr-a" style="display: flex;" onclick="delete_widget_contact_comm(' +
             recid + ')"> \
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24" class="icon"> \
                      <path d="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z"> \
                      </path> \
         ...
         $.ajax({
             ...
             success: function(result) {
                 ...
                 if (recid_widget_memorial == '') {
                     ...
                     document.getElementById('div_widget_memorial' + recid_widget_memorial).innerHTML =
                         newHtml;
                 }
     ...
     function edit_widget_memorial(recid) {
         ...
         // alert('recid: '+recid);
         var delete_btn_code =
             ' <button id="btn_widget_memorial_delete" class="linear-warning w-120px mr-a" style="display: flex;" onclick="delete_widget_memorial(' +
             recid + ')"> \
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24" class="icon"> \
                      <path d="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z"> \
                      </path> \
         ...
         $.ajax({
             ...
             success: function(result) {
                 ...
                 document.getElementById('memorial_answer_mandatory').value = result
                     .memorial_answer_mandatory;
             ...
             $.ajax({
                 ...
                 success: function(result) {
                     ...
                     if (recid_widget_image == '') {
                         ...
                         document.getElementById('div_widget_image' + recid_widget_image).innerHTML =
                             newHtml;
                     }
     ...
     function edit_widget_image(recid) {
         ...
         var delete_btn_code =
             '<button id="btn_widget_image_delete" class="linear-warning w-120px mr-a" style="display: flex;" onclick="delete_widget_image(' +
             recid + ')"> \

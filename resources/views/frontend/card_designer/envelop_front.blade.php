<div id="div_envelop_front" class="jetp-envelope-editor" style="background-color: rgb(163, 108, 66); background-image: url(&quot;/data/assets/background/61624_tn.webp&quot;); display: none;">
                            <div class="envelope-background-gradiant"></div>
                            <header class="jetp-header">
                                <button class="fl filled save animate__pulse" onclick="showhide('div_card_music',['div_envelop_front','div_envelop_back','div_envelop_seal'])">    
                                ...
                                <button class="fr icon" onclick="showhide('div_post_card',['div_envelop_front'])" ><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24" class="icon localize">
                            ...
                            <div class="jetp-content jetp-envelope-template">
                                <div class="jetp-sub-header">
                                    ...
                                    <div class="item active primary-color" onclick="showhide('div_envelop_front',['div_envelop_seal','div_envelop_back'])"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24" class="icon">
                            ...
                            <div class="jetp-toolbar justify-center h-l"><button class="circle ml-5"  onclick="showhide('div_envelop_designs',['div_inside_images','div_backgrounds'])">
                                ...
                                </button><button class="circle ml-5" onclick="showhide('div_inside_images',['div_envelop_designs','div_backgrounds'])">
                                    <div class="icon-cover"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24" class="icon primary-color">
                                ...
                                </button><button class="circle ml-5" onclick="showhide('div_backgrounds',['div_envelop_designs','div_inside_images'])">
                                    <div class="icon-cover"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24" class="icon primary-color">

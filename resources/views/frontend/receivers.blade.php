...
@section('content')
                ...
                @foreach ($recipients as $recipient)
                    <div id="div_recipient_{{ $recipient->id }}" class="receiver-row m-20-10 mb-20">
                        <div class="row head">
                            ...
                            @isset($recipient->transaction_id)
                                <a class="menu mr-a" href="{{ url('play/' . $cardId) . '/' . $recipient->url }}" target="_blank"
                                    title="View card"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="row date">
                            ...
                            @empty($recipient->transaction_id)
                                <div class="buttons mr-a"><button class="play ml-10" style="display: none;"><svg
                                        ...
                                        onclick="open_confirmation_for_bronze_stamp(event, '{{ $recipient->id }}');"
    ...
    <div class="jetp-dialog-overlay show" style="display: none;">
        <div class="jetp-dialog auto-size small">
            ...
            <input type="hidden" id="current_confirmation_recipient_id" />
        </div>
    </div>
...
@endif
    ...
    <div id="div_insert_recipient_name" class="jetp-dialog-overlay show" style="display: none;">
        <div class="jetp-dialog modal medium">
            ...
            <div class="jetp-footer p-20-10" style="display: flex;"><button
                    onclick="hide_div('div_insert_recipient_name');deduct_bronze_stamp()" class="success ml-5"><span
    ...
    <!-- Modal alert -->
    <div id="div_modal_alert" class="jetp-dialog-overlay show" style="display: none;">
        <div class="jetp-dialog modal auto-size small">
            <div class="jetp-header">
                <div class="jetp-back" style="display: none;"><svg xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24"
                ...
                <div class="jetp-title no-wrap pr-20"><span wudooh="true"
                        style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                        <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">Alert</font>
                        </font>
                    </span></div>
                <div style="display: none;"></div>
                <div class="jetp-close"><svg xmlns="http://www.w3.org/2000/svg" onclick="hide_div('div_modal_alert')"
                        xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24"
                        height="24" viewBox="0 0 24 24" class="icon">
                        <path
                            d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z">
            ...
            <div class="jetp-content nice-scrollbar">
                <div class="jetp-receiver-dialog w-100">
                    ...
                    <div id="modal_alert_message" style="padding: 20px"></div>

                </div>
            </div>
            <div class="jetp-footer p-20-10" style="display: flex;"><button class="success ml-10"
                    onclick="hide_div('div_modal_alert')"><span wudooh="true"
                        style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                        <font style="vertical-align: inherit;">
    ...
    <!-- Inventory increase alert -->
    <div id="div_inventory_increase" class="jetp-dialog-overlay show" style="display: none;">
        <div class="jetp-dialog modal auto-size small">
            <div class="jetp-header">
                <div class="jetp-back" style="display: none;"><svg xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24"
                ...
                <div class="jetp-title no-wrap pr-20"><span wudooh="true"
                        style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                        <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">Insufficient balance</font>
                        </font>
                    </span></div>
                <div style="display: none;"></div>
                <div class="jetp-close"><svg xmlns="http://www.w3.org/2000/svg"
                        onclick="hide_div('div_inventory_increase')" xmlns:xlink="http://www.w3.org/1999/xlink"
                        version="1.1" fill="currentColor" width="24" height="24" viewBox="0 0 24 24"
                        class="icon">
                        <path
                            d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z">
            ...
            <div class="jetp-content nice-scrollbar">
                <div class="jetp-receiver-dialog w-100">
                    ...
                    <div id="div_inventory_increase_message" style="padding: 20px">
                        The balance of bronze stamp is insufficient.
                    </div>

                </div>
            </div>
            <div class="jetp-footer p-20-10" style="display: flex;"><button class="success ml-10"
                    onclick="document.location.href='{{ route('chargplan') }}';"><span wudooh="true"
                        style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                        <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">Inventory increase</font>
                        </font>
                    </span></button><button class="gray ml-10" onclick="hide_div('div_inventory_increase')"><span
                        wudooh="true" style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                        <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">Close</font>
                        </font>
    ...
    <script>
        ...
        function reset_addrecipient_form() {
            document.getElementById('prefix').value = 'No prefix';
            document.getElementById('recipient_name').value = '';
            document.getElementById('mobile_no').value = '';
            document.getElementById("recipient_email").value = '';
            document.getElementById('rec_recipient_id').value = '';
        ...
        function send_email_to_recipients() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    document.getElementById("modal_alert_message").innerHTML = result.message;
                    document.getElementById("div_modal_alert").style.display = "flex";
                },
                error: function(xhr, status, error) {
                    // Handle the error
                    console.log('Error: ' + error);
        ...
        function open_confirmation_for_bronze_stamp(event, recipient_id) {
            showhide('div_insert_recipient_name', []);
            document.getElementById('current_confirmation_recipient_id').value = recipient_id;
        }

        function deduct_bronze_stamp(recipient_id) {
            var card_id = document.getElementById("recipient_cardid").value;
            var recipient_id = document.getElementById('current_confirmation_recipient_id').value;
            $.ajax({
                url: "{{ url('mycards/deduct_bronze_stamp') }}",
                type: "post",
                data: {
                    card_id: card_id,
                    recipient_id: recipient_id,
                ...
                success: function(result) {
                    if (result.success) {
                        ...
                        // document.getElementById("div_modal_alert").style.display = "flex";
                        location.reload();
                    } else if (result.error && result.error_code == 'insufficient_balance') {
                        document.getElementById("div_inventory_increase").style.display = "flex";
                    }
                },
                error: function(xhr, status, error) {
                    // Handle the error

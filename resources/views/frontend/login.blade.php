        ...
        <div id="app">
            <div class="jetp-login-page">
                ...
                <header class="jetp-header fixed" style="position: fixed; left: 0px; right: 0px;">
                    <a href="{{ url('home') }}" class="fr icon"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="input-password"><input type="password" name="password" id="txtPassword">
                    <div class="eye off"><svg xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="currentColor" width="24"
                            height="24" viewBox="0 0 24 24" class="icon off">
                            <path
                ...
                <a href="{{ url('forgot') }}" class="change title mb-20" style="font-size: 12px;"><span><span
                            wudooh="true"
                            style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                            <font style="vertical-align: inherit;">
                ...
                <button type="submit" class="fill mb-40"><span wudooh="true"
                    ...
                    </span></button><a href="{{ url('register') }}" class="change"><span class="ml-5"><span
                            wudooh="true"
                            style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                            <font style="vertical-align: inherit;">
                ...
                <a href="{{ route('google.redirect') }}" class="change"><span class="ml-5"><b><span wudooh="true"
                                style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">Login with Google</font>
                                </font>
                            </span></b></a>

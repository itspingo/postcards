                    ...
                    <div class="item is-desktop">
                        ...
                        <div class="info">
                            <div class="row mt-10 mb-10">
                                ...
                                <a class="menu mr-a " href="{{ url('play/' . $mycard->id) }}" target="_blank"
                                ...
                                <div class="menu mr-5 " onclick="show_card_share_popup({{ $mycard->id }})"><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        version="1.1" fill="currentColor" width="24" height="24"
                                        viewBox="0 0 24 24" class="icon" style="margin-right: 3px;">
                                        <path
                                ...
                                <div class="menu mr-5 elemid_88wpmg " onclick="show_mycard_options({{ $mycard->id }})">
                                ...
                                <div id="{{ 'div_mycard_options' . $mycard->id }}"
                                    class="jetp-menu open id_88wpmg small active"
                                    style="right: 36px; top: 208px; display:none;">
                                    <a class="option primary-color" href="{{ url('play/' . $mycard->id) }}"
                                    ...
                                    <div class="option"><a href="{{ url('card_designer/' . $mycard->id) }}"><svg
                                    ...
                                    <div class="option"><a href="{{ url('mycards/card_copy/' . $mycard->id) }}"><svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                fill="currentColor" width="24" height="24" viewBox="0 0 24 24"
                                                class="icon">
                                                <path
                                                    ...
                                                    style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                                    <font style="vertical-align: inherit;">
                                                        <font style="vertical-align: inherit;">Making a copy of the card
                                                        </font>
                                                    </font>
                                                </span></span></a></div>
                                    <div class="option"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div class="option"><a href="{{ url('mycards/card_delete/' . $mycard->id) }}"><svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                fill="currentColor" width="24" height="24" viewBox="0 0 24 24"
                                                class="icon">
                            ...
                            <div class="row date mt-10">
                                <div class="col create" style="display: block;">
                                    ...
                                    <div class="detail"><span><span wudooh="true"
                                                style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                                <font style="vertical-align: inherit;">
                                ...
                                @if ($mycard->updated_at)
                                    <div class="col update" style="display: block;">
                                        ...
                                        <div class="detail"><span>
                                                <font style="vertical-align: inherit;">
                                                    <font style="vertical-align: inherit;">{{ $mycard->updated_at }}
                                                    </font>
                                                </font>
                                            </span></div>
                                    </div>
                            ...
                            <div class="row state mt-10 mb-5">
                                ...
                                <div class="col cursor">
                                    <div class="title"><span wudooh="true"
                                            ...
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">
                                                    <a href="{{ url('mycards/receivers/' . $mycard->id) }}">
                                                        receivers
                                                    </a>
                                                </font>
                                            </font>
                                ...
                                <div class="col cursor">
                                    <div class="title" onclick="load_messages({{ $mycard->id }})"><span
                                            wudooh="true"
                                            style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                            <font style="vertical-align: inherit;">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <button class="fr icon" onclick="showhide('div_cards',['div_messages'])">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    version="1.1" fill="currentColor" width="24" height="24"
                                    viewBox="0 0 24 24" class="icon localize">
                                    <path d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z">
                                    </path>
                                </svg>
                            </button>

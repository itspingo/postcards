...
<body>
            ...
            <div class="flip-card-inner" id="flip-card-inner">
                <div class="flip-card-back">
                    ...
                    <div style="position: relative;">
                        ...
                        <img src="@if (isset($card_info->front_image)) {{ url($card_info->front_image) }} @else {{ url('website/assets/images/2001_front.webp') }} @endif"
                            alt="Avatar" class="imageBack1" />
                        <!-- image of company signature that shows upside on first image in bottom right corner -->

                        <img src="@if (isset($card_info->stamp_design)) {{ url($card_info->stamp_design) }} @else {{ url('website/assets/images/2001_front.webp') }} @endif"
                            alt="Avatar" class="imageBack2" />
                        <img id="img_stamp_image" class="jetp-stamp stamp_image"
                            src="@if (isset($card_info->stamp_image)) {{ url($card_info->stamp_image) }} @else {{ url('website/assets/images/5396.webp') }} @endif">
                ...
                <div class="flip-card-front" style="position: relative;height:auto;">
                    ...
                    <img src="{{ url('storage/' . str_replace('public/', '', $card_info->card_image)) }}"
                        alt="Avatar" class="innerPicture" id="innerPicture" style="display: none;" />

                    <img src="@if (isset($card_info->back_image)) {{ url($card_info->back_image) }} @else {{ url('website/assets/images/2001_back.webp') }} @endif"
                        alt="Avatar" class="imageFront1" />

                    <img src="@if (isset($card_info->back_image)) {{ url($card_info->back_image) }} @else {{ url('website/assets/images/2001_back.webp') }} @endif"
                        alt="Avatar" class="duplicateImage" id="duplicateImage" />
                    <!-- End -->
                    ...
                    <div class="frontImageContainer" id="frontImageContainer">
                        ...
                        <img src="@if (isset($card_info->envelop_inside_image)) {{ url($card_info->envelop_inside_image) }} @else {{ url('website/assets/images/1001.webp') }} @endif"
                            alt="Inner image" class="imgclass" id="imageContainer1" />



                        <!-- front side of letter upper part image -->
                        <img src="@if (isset($card_info->flap_image)) {{ url($card_info->flap_image) }} @else {{ url('website/assets/images/2001_flap.webp') }} @endif"
                            alt="Avatar" class="imageFront" id="imageFront" />

                        <!-- middle part of front side where click function work -->


                        <img src="@if (isset($card_info->seal_design)) {{ url($card_info->seal_design) }} @else {{ url('website/assets/images/7222.front.webp') }} @endif"
                            alt="Seal" class="imageFront3" id="imageFront3" />
                        ...
                        @foreach ($sortedCollection as $wdgtRec)
                            ...
                            @if ($wdgtRec instanceof \App\Models\widget_user_text_model)
                                ...
                                <section class="digipostal-p2bmbg"
                                    ...
                                    <div class="digipostal-eiaxmh digipostal-oi9shj"
                                        style="text-align: {{ $wdgtRec->user_text_alignment ?? center }};"><span
                                            wudooh="true"
                                            style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">{{ $wdgtRec->user_text }}
                                                </font>
                                            </font>
                                        </span></div>
                                </section>
                                ...
                                <section class="jetp-ngl4yv">
                                    <div class="jetp-feffm jetp-qpo9lj jetp-zs0p7">
                                        <span wudooh="true"
                                            style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">{{ $wdgtRec->countdown_title }}
                                                </font>
                                            </font>
                                        </span>
                                    </div>
                                ...
                                <section class="jetp-ngl4yv">
                                    <div class="jetp-feffm jetp-lxpam jetp-zs0p7"><svg
                                        ...
                                        <span
                                            ...
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">
                                                    {{ $wdgtRec->text_question_title }}</font>
                                            </font>
                                        </span>
                                    </div>

                                    @if ($wdgtRec->text_question_type == 'name')
                                        <input type="text" id="answer_text_question" name="answer_text_question[]"
                                            maxlength="60" class="jetp-k9u3p">
                                    @elseif($wdgtRec->text_question_type == 'number')
                                        <input type="number" id="answer_text_question" name="answer_text_question[]"
                                            maxlength="60" class="jetp-k9u3p">
                                    @elseif($wdgtRec->text_question_type == 'phone')
                                        <input type="tel" id="answer_text_question" name="answer_text_question[]"
                                            maxlength="60" class="jetp-k9u3p">
                                    @elseif($wdgtRec->text_question_type == 'email')
                                        <input type="email" id="answer_text_question" name="answer_text_question[]"
                                            maxlength="60" class="jetp-k9u3p">
                                ...
                                <section class="jetp-ngl4yv">
                                    <div class="jetp-feffm jetp-lxpam jetp-zs0p7">
                                        ...
                                        <span
                                            ...
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">
                                                    {{ $wdgtRec->attend_quest_title }}</font>
                                            </font>
                                        </span>
                                    </div>
                                    ...
                                    <div class="jetp-k9u3p">
                                        ...
                                        <span>
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">
                                                    {{ $wdgtRec->attend_quest_yes_title }}</font>
                                            </font>
                                        </span>
                                    </div>
                                    <div class="jetp-k9u3p">
                                        ...
                                        <span>
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">
                                                    {{ $wdgtRec->attend_quest_no_title }}</font>
                                            </font>
                                        </span>
                                    </div>
                            ...
                            @elseif($wdgtRec instanceof \App\Models\widget_memorial_model)
                                ...
                                <section class="digipostal-p2bmbg"
                                    ...
                                    <div class="digipostal-eiaxmh digipostal-q1qsqj digipostal-gsa05"><span><span
                                                wudooh="true"
                                                style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                                <font style="vertical-align: inherit;">
                                                    <font style="vertical-align: inherit;">
                                                        {{ $wdgtRec->memorial_title }} * </font>
                                                </font>
                                            </span></span></div>
                                    <div class="digipostal-nlrnuu" style="flex-direction: column; padding: 0px;">
                                        <textarea rows="5" maxlength="300" name="answer_memorial[]" id="answer_memorial"
                                            placeholder="Enter your message" class="digipostal-nlrnuu"
                            ...
                            @elseif($wdgtRec instanceof \App\Models\widget_video_model)
                                <div class="widget p-20-10" item="jetp-ck8mj">
                                    <div>
                                        <section class="jetp-ngl4yv">
                                            <iframe src="{{ $wdgtRec->video_link }}" frameborder="0"
                            ...
                            @elseif($wdgtRec instanceof \App\Models\widget_social_network_model)
                                <section class="jetp-ngl4yv">
                                    <div class="jetp-feffm jetp-qpo9lj jetp-zs0p7" align="center"
                                        style=";font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                        <font style="vertical-align: inherit;">
                                    ...
                                    <div
                                        ...
                                        @if ($wdgtRec->sn_telegram != '')
                                            <a class="jetp-b6x308" href="{{ $wdgtRec->sn_telegram }}"
                                                ...
                                                style="background: linear-gradient(315deg, rgb(64, 175, 238), rgba(64, 175, 238, 0.7)); padding: 0px;"><svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                    fill="currentColor" width="48" height="48"
                                        ...
                                        @if ($wdgtRec->sn_whatsapp != '')
                                            <a class="jetp-b6x308"
                                                href="whatsapp://send?phone={{ $wdgtRec->sn_whatsapp }}"
                                                target="_blank"
                                        ...
                                        @if ($wdgtRec->sn_twitter != '')
                                            <a class="jetp-b6x308" href="{{ $wdgtRec->sn_twitter }}" target="_blank"
                            ...
                            @elseif($wdgtRec instanceof \App\Models\widget_link_model)
                                <section class="jetp-ngl4yv jetp-k9u3p">
                                    <a class="jetp-ykszmm" style="padding-top: 20px;padding-bottom: 20px;"
                                        href="{{ $wdgtRec->link_url }}" rel="nofollow" target="_blank"><span
                                            style="flex: 1 1 0%; margin: 0px 5px;">
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">{{ $wdgtRec->link_text }}
                                                </font>
                                            </font>
                                        </span><svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                            fill="currentColor" width="24" height="24" viewBox="0 0 24 24"
                                            class="icon" style="margin: 0px 5px;">
                                            <path
                                ...
                                <section class="jetp-ngl4yv">
                                    <div class="jetp-feffm jetp-lxpam jetp-zs0p7">
                                        ...
                                        <span
                                            ...
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">
                                                    {{ $wdgtRec->optnl_quest_title }}</font>
                                            </font>
                                        </span>
                                    </div>
                                    ...
                                    @if ($wdgtRec->optnl_quest_type == 'checkbox')
                                        @foreach ($aroptnl_quest_options as $optnl_quest_option)
                                            <div class="jetp-k9u3p" style="cursor: pointer;"><svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                                    fill="currentColor" width="24" height="24"
                                                    viewBox="0 0 24 24" class="icon jetp-kxy58n active"
                                                    style="display: none;">
                                                    <path
                                                ...
                                                </svg><input type="checkbox" name="answer_optnl_quest[]"
                                                    value="{{ $optnl_quest_option }}">
                                                <span style="flex: 1 1 0%; margin: 0px 5px;">
                                                    <font style="vertical-align: inherit;">
                                                        <font style="vertical-align: inherit;">
                                                            {{ $optnl_quest_option }}</font>
                                                    </font>
                                                </span>
                                            </div>
                                        @endforeach
                                    ...
                                    @if ($wdgtRec->optnl_quest_type == 'radio')
                                        @foreach ($aroptnl_quest_options as $optnl_quest_option)
                                            <div class="jetp-k9u3p" style="cursor: pointer;"><svg
                                                ...
                                                </svg><input type="radio" name="answer_optnl_quest[]"
                                                    value="{{ $optnl_quest_option }}">
                                                <span style="flex: 1 1 0%; margin: 0px 5px;">
                                                    <font style="vertical-align: inherit;">
                                                        <font style="vertical-align: inherit;">
                                    ...
                                    @if ($wdgtRec->optnl_quest_type == 'dropdown')
                                        <div class="jetp-cover-input m-20-10 mt-20">
                                            ...
                                            <select id="optnl_quest_type" name="answer_optnl_quest[]">
                                                @foreach ($aroptnl_quest_options as $optnl_quest_option)
                                                    <option value="{{ $optnl_quest_option }}"><span wudooh="true"
                                                            style="font-size:1.05em;line-height:1.1em;font-family:&quot;Sahl Naskh&quot;;">
                                                            <font style="vertical-align: inherit;">
                                                                <font style="vertical-align: inherit;">
                                                                    {{ $optnl_quest_option }}</font>
    ...
    <script>
        var modes = {
            cannon: function cannon(defaults) {
                confetti({
                    ...defaults,
                    particleCount: 100,
                    spread: 70,
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            const nextStyle = () => {
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        logic = !logic;
                        document.getElementById("duplicateImage").style.display = time ?
                            "none" : "block";
                        document.getElementById("innerPicture").classList.toggle(
                            'innerPicture2', logic);
                        document.getElementById("flipCard").style.rotate = time ? "40deg" :
                            "0deg";

                        var effect_name = "{{ $card_info->effect_name }}";
                        if (effect_name != "") {
                            try {
                                modes[effect_name]();
                            } catch (err) {
    ...
    <script>
        function validate_widget_form() {
            ...
            if (isTextAreaFilled || isRadioCheckedYes || isRadioCheckedNo || isTextQuestionFilled ||
                isSelectQuestTypeSelected) {
    ...
    <style>
        ...
        .jetp-k9u3p {
            ...
            width: 100%;
            padding: 10px 15px;
            /* Adjust padding to control spacing from border */
